  ...
  public:
    ...
    void OnAttached() override
    {
      ...
      AddChildControl(new IURLControl(GetRECT().SubRectVertical(5, 0), "NEURAL AMP MODELER",
                                      "https://www.AmpForge.com", mText, COLOR_TRANSPARENT,
                                      PluginColors::HELP_TEXT_MO, PluginColors::HELP_TEXT_CLICKED));
      AddChildControl(new IVLabelControl(GetRECT().SubRectVertical(5, 1), "By AmpForge", mStyle));
      ...
      AddChildControl(new IURLControl(GetRECT().SubRectVertical(5, 3),
                                      ...
                                      "https://github.com/sdatkinson/AmpForgePlugin/graphs/contributors", mText,
