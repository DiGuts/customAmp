#define PLUG_NAME "AmpForge"
#define PLUG_MFR "AmpForge"
#define PLUG_VERSION_HEX 0x00000100
#define PLUG_VERSION_STR "0.1.0"
#define PLUG_UNIQUE_ID 'AFrg'
#define PLUG_MFR_ID 'AFrM'
#define PLUG_URL_STR ""
#define PLUG_EMAIL_STR ""
#define PLUG_COPYRIGHT_STR "Copyright 2025 AmpForge"
#define PLUG_CLASS_NAME AmpForge
#define BUNDLE_NAME "AmpForge"
#define BUNDLE_MFR "AmpForge"
#define BUNDLE_DOMAIN "com"

#define SHARED_RESOURCES_SUBPATH "AmpForge"
...
#define AUV2_ENTRY AmpForge_Entry
#define AUV2_ENTRY_STR "AmpForge_Entry"
#define AUV2_FACTORY AmpForge_Factory
#define AUV2_VIEW_CLASS AmpForge_View
#define AUV2_VIEW_CLASS_STR "AmpForge_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "AmpForge\nIPEF"
